...
namespace Marten.Generated.EventStore
{
    ...
    public sealed class GeneratedEventDocumentStorage : Marten.Events.EventDocumentStorage
    {
        ...
        public override void ApplyReaderDataToEvent(System.Data.Common.DbDataReader reader, JasperFx.Events.IEvent e)
        {
            ...
            {
            var userName = reader.GetFieldValue<string>(9);
            e.UserName = userName;
            }
        ...
        public override async System.Threading.Tasks.Task ApplyReaderDataToEventAsync(System.Data.Common.DbDataReader reader, JasperFx.Events.IEvent e, System.Threading.CancellationToken token)
        {
            ...
            {
            var userName = await reader.GetFieldValueAsync<string>(9, token).ConfigureAwait(false);
            e.UserName = userName;
            }
    ...
    public sealed class AppendEventOperation : Marten.Events.Operations.AppendEventOperationBase
    {
        ...
        {
            builder.Append("insert into public.mt_events (data, type, mt_dotnet_type, id, stream_id, version, timestamp, tenant_id, user_name, seq_id) values (");
            ...
            var parameter8 = Event.UserName != null ? parameterBuilder.AppendParameter(Event.UserName) : parameterBuilder.AppendParameter<object>(System.DBNull.Value);
    ...
    public sealed class QuickAppendEventsOperation : Marten.Events.Operations.QuickAppendEventsOperationBase
    {
        ...
        public override void ConfigureCommand(Weasel.Postgresql.ICommandBuilder builder, Marten.Internal.IMartenSession session)
        {
            ...
            writeUserNames(parameterBuilder, session);
            builder.Append(')');
        }
